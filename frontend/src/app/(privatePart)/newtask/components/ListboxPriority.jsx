...
const ListboxPriority = () => {
  const [selectedPriority, setSelectedPriority] = useState(prioridad[0])
                    ...
                    <>
                      <span
                        className={`block truncate ${
                          selectedPriority ? "font-medium" : "font-normal"
                        }`}>
                        {priority}
                      </span>
                      {selectedPriority ? (
...
export default ListboxPriority
